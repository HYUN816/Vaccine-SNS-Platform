...
function EditProfile({
	...
	const vachineOptions = [
		{ value: "MD", label: "모더나", key: "vaccine" },
		{ value: "AZ", label: "아스트라제네카", key: "vaccine" },
		{ value: "PZ", label: "화이자", key: "vaccine" },
		{ value: "JS", label: "얀센", key: "vaccine" },
	];
	...
	return (
		<EditProfileWrap>
			...
			<EditItemBlock>
				...
				<EditInput value={age} onChange={onChangeInput} type="number" />
			</EditItemBlock>
			<EditItemBlock>
				<EditLabelWrap>
